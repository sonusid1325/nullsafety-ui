        ...
        <Card className="w-96">
          <CardContent className="pt-6">
            <div className="text-center space-y-4">
              ...
              <h2 className="text-xl font-semibold">Institution Dashboard</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">Manage certificates and institution settings</p>
            </div>
          ...
          <Dialog open={isCreateModalOpen} onOpenChange={setIsCreateModalOpen}>
            ...
            <DialogContent className="sm:max-w-[525px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Create a new certificate for a student. This will be stored on the blockchain.
                </DialogDescription>
              </DialogHeader>
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium">Student Wallet Address (Optional)</label>
                  <input
                    type="text"
                  ...
                  <div className="flex justify-between items-start">
                    <div className="space-y-2">
                      <div className="flex items-center space-x-2">
                        <h3 className="font-semibold">{certificate.student_name}</h3>
                      ...
                      <p className="text-sm text-gray-500">
                        Grade: {certificate.grade} • Issued: {certificate.issued_date}
                      </p>
